...
function Infocard({ title, theme = 'lime', level = 300, discription, Icon }) {
  ...
  return (
    <div className={`w-[48%] se:w-[44%] h-64 rounded-xl shadow-lg flex flex-col items-center justify-center sm:text-4xl text-xl font-semibold p-2 ${bgColor} ${textColor} hover:scale-105 transition-transform duration-300`}>
